...
translation.translatealllabels(handles.fig);
try
...
fig = openfig('mymenu.fig','reuse');
set(fig,'visible','off');%menu not visble until it is horisontally aligned 
...
handes.default = default;
handles.m = 0; %default...

%Set handles.
set(handles.fig,'name',header);
